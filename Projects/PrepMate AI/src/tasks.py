    ...
    def research_task(self, agent, meeting_participants, meeting_context):
        return Task(
            description=dedent(f"""
                ...
                Currently its December 2024. Gather information on recent news, achievements, professional background, their linkedin Information and any relevant business activities.

...
from src.tasks import EmailMeetingPrepTask
from src.agents import EmailMeetingPrepAgents

load_dotenv()


def run_crew(meeting_participants, meeting_context, meeting_objective):
    ...
    return summary_and_briefing_task.output.raw
